...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if (firebaseAuth.getCurrentUser() == null || !firebaseAuth.getCurrentUser().isEmailVerified()) {
            ...
            // Check and start Shake Detection Service if enabled
            if (com.android.sheguard.config.Prefs.getBoolean(com.android.sheguard.common.Constants.SETTINGS_SHAKE_DETECTION, false)) {
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (com.android.sheguard.service.SosService.isRunning) {
            com.android.sheguard.util.SosUtil.stopSosNotificationService(this);
        }
    }
}