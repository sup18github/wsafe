...
public class SettingsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding.switchRecordEvidence.setChecked(Prefs.getBoolean(Constants.SETTINGS_RECORD_EVIDENCE, true));
        binding.switchRecordEvidence.setOnCheckedChangeListener((buttonView, isChecked) -> Prefs.putBoolean(Constants.SETTINGS_RECORD_EVIDENCE, isChecked));
        binding.recordEvidenceContainer.setOnClickListener(v -> binding.switchRecordEvidence.toggle());

        binding.adminPanelContainer.setOnClickListener(v -> {
            startActivity(new Intent(requireContext(), com.android.sheguard.ui.activity.AdminDashboardActivity.class));
        });
